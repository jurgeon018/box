    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liqpay_public_key', models.TextField(default='i62885989298', verbose_name='Публічний ключ')),
                ('liqpay_private_key', models.TextField(default='HwWMv4AfpGjsJllHnNooqbBik13iQ6CylVKN32Z6', verbose_name='Приватний ключ')),
                ('liqpay_sandbox_public_key', models.TextField(default='sandbox_i25008597925', verbose_name='Тестовий публічний ключ')),
                ('liqpay_sandbox_private_key', models.TextField(default='sandbox_cP9OLjYYYruhkfFtHJKqfBUhFYMGi6is7Jt7ml7n', verbose_name='Тестовий приватний ключ')),
                ('sandbox_mode', models.BooleanField(default=0, verbose_name='Тестовий режим')),
            ],
            options={
